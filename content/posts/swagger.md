...
>
> https://editor.scalar.com

```bash
@ curl -LRko swagger-codegen-cli.jar https://maven.proxy.ustclug.org/maven2/io/swagger/codegen/v3/swagger-codegen-cli/3.0.75/swagger-codegen-cli-3.0.75.jar
